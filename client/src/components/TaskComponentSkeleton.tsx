const TaskComponentSkeleton = () => {
    ...
    >
      <h3
        className="animate-pulse pl-1 pr-1 h-[32px]"
      >
      </h3>
      <p className="h-20 mb-4 p-1 animate-pulse ">
      </p>
      <div className="flex flex-col sm:flex-row justify-center gap-2 w-full mt-2 p-2">
        <button
          className="animate-pulse h-[24px] w-[75.672px] flex-1 border border-violet-600 rounded transition"
         >
        </button>
        <button
          className="animate-pulse h-[24px] w-[75.672px] flex-1 border border-violet-600 rounded transition"
